...
In summary, a probe that asks *"Is this the same TPM instance that the OEM originally certified?"* will always fail after HWID spoofing.
...
Therefore, it is useless to try to bypass the program this way. The software is useful for you to check the integrity and trust of your own TPM.